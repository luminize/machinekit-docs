...
As of now you have the choince running Machinekit on a Debian Wheezy (7) or an
Debian Jessie (8) installation. Please take note of different instructions
when they apply. These "notes" will be like this:

[NOTE]
====
Please take note that you have to choose between "wheezy" and "jessie" here.
====
...
[NOTE]
====
Please choose between "wheezy" and "jessie" here.
====

Copy and paste the following into a shell to configure the package archive for:
